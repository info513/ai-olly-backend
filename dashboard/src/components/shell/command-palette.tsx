...
const ACTIONS: Action[] = [
  ...
  { id: "add-knowledge", label: "Teach Olly an answer", icon: Sparkles, href: "/ai/knowledge/new", group: "Create", module: "ai" },
  { id: "upload-asset", label: "Upload photo", icon: Upload, href: "/assets/upload", group: "Create", module: "assets" },
  { id: "new-campaign", label: "New campaign", icon: Send, href: "/newsletter/campaigns/new", group: "Create", module: "newsletter" },
  { id: "create-segment", label: "Create audience", icon: Filter, href: "/newsletter/segments", group: "Create", module: "newsletter" },
  { id: "create-template", label: "Create email design", icon: Mail, href: "/newsletter/templates/new", group: "Create", module: "newsletter" },
  { id: "find-subscriber", label: "Find contact", icon: Users, href: "/newsletter/subscribers", group: "Create", module: "newsletter" },
  ...
  { id: "test-ai", label: "Try Olly", icon: PlayCircle, href: "/ai/preview", group: "Go", module: "ai" },
  { id: "knowledge", label: "What Olly knows", icon: BookOpen, href: "/ai/knowledge", group: "Go", module: "ai" },
  { id: "unanswered", label: "Questions Olly couldn't answer", icon: MessageSquare, href: "/ai/unanswered", group: "Go", module: "ai" },
  { id: "find-image", label: "Find a photo", icon: ImageIcon, href: "/assets/images", group: "Go", module: "assets" },
  { id: "find-document", label: "Find a document", icon: FileText, href: "/assets/documents", group: "Go", module: "assets" },
  { id: "unused-assets", label: "Unused photos", icon: Link2Off, href: "/assets/usage?filter=unused", group: "Go", module: "assets" },
  { id: "missing-alt", label: "Photos missing alt text", icon: ImageIcon, href: "/assets/images?filter=missing-alt", group: "Go", module: "assets" },
  ...
  { id: "analytics", label: "Insights overview", icon: Activity, href: "/analytics", group: "Go", module: "analytics" },
  { id: "ai-handoffs", label: "Questions handed to reception", icon: Activity, href: "/analytics/ai", group: "Go", module: "analytics" },
