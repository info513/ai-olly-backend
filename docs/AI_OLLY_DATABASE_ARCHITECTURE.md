...
- **Package B (AI Knowledge, Guests, Reception, Newsletter, Storage, Airtable migration/cutover) not started.** Production, Airtable, Render and the guest PWA **untouched**; `DATA_PROVIDER=airtable`.
