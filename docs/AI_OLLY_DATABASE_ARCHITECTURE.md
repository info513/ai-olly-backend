...
- **Package C (Newsletter, Storage buckets/Asset Manager, Analytics, provider cutover, Airtable migration) not started.** Production, Airtable, Render and the guest PWA **untouched**; `DATA_PROVIDER=airtable`.
