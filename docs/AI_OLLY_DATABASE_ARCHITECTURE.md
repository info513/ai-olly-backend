...
- **POIs, destination content, routes, pricing engine, AI knowledge, guests/stays, reception, newsletter, media/storage not started.** Production, Airtable, Render and the guest PWA **untouched**; `DATA_PROVIDER=airtable`.
