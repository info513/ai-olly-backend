...
## ✅ RESOLVED (2026-07-31): official contact info confirmed by the hotel
The hotel confirmed the canonical guest-facing values and they are now reconciled across HOTELI, config.js and the AI contact handlers:
| Field | Official value |
|---|---|
| Telephone | **+385 21 785 208** |
| Mobile | **+385 91 525 6985** |
| Address | **Poljana Grgura Ninskog 1** |
The previous conflicting `+385992140829` / `Ul. Dioklecijanova 1` were removed everywhere. No OPEN contact conflicts remain. (See AI_ANSWER_AUDIT_ROUND_1.md F4.)
