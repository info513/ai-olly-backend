...
> **Progress update (2026-08-02):** implementation on `feature/ai-olly-platform-2`, `aiolly-dev` only. **Steps 1–7 applied & verified**: cross-cutting (35), tenancy & identity (50), rooms/Room Guide — Pattern C (40), Hotel Services — Pattern A (76), **Package A: Destination Content + Presentation (Pattern B) + Pricing (Pattern A) (90)**. All integrated with Step 1 versioning/audit/retention. Production, Airtable, Render and the guest PWA remain untouched (`DATA_PROVIDER=airtable`). Next: **Package B** (AI Knowledge / Guests / Reception / Newsletter / Storage) — not started, awaiting go-ahead. See `DATABASE_MIGRATION_STEP_1..4.md` + `_STEP_5_6_7.md`.
